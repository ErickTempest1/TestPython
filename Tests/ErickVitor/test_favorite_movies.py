...
url = "https://api.themoviedb.org/3/account/22485758/favorite/movies?language=en-US&page=1&sort_by=created_at.asc"
...
def test_can_get_favorite_movies():
    response = requests.get(url, headers=headers)
    assert response.status_code == 200

def test_can_get_first_favorite_movie_details():
